...
\begin{enumerate}
    ...
    Because the signal source output impedance is \SI{100}{\ohm}, we select a value 10 times higher: $R_1 = \SI{1}{\kohm}$ then:
    \[C_1 = \frac{\SI{1.6}{\ms}}{\SI{1}{\kohm}} = \mans{\SI{1.6}{\micro\farad}}\]
    \item
    Given $f_2 = \SI{10}{\kHz}$ from the question:
    \[R_2*C_2 = \frac{1}{2\pi*\SI{10}{\kilo\hertz}} = \SI{16}{\micro\second} \]
    Because the output impedance of the high-pass filter was approximately \SI{1}{\kilo\ohm}, we select a value 10 times greater: $R_2 = \SI{10}{\kilo\ohm}$  then:
    \[C_2 = \frac{\SI{16}{\micro\second}}{\SI{10}{\kilo\ohm}} = \mans{\SI{1.6}{\nano\farad}}\]
\end{enumerate}
