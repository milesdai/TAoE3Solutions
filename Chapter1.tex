...
\begin{enumerate}
    ...
    \[R_1*C_1 = \frac{1}{2\pi*100} = \SI{1.5}{\ms} \]
    Select $R_1 = \SI{1}{\kohm}$ then:
    \[C_1 = \frac{1.5*0.001}{1000} = \SI{1.5}{\micro\farad}\]
    \item
    Given $f_2 = \SI{10}{\kHz}$ from the question:
    \[R_2*C_2 = \frac{1}{2\pi*10000} = \SI{0.15}{\ms} \]
    Select $R_2 = \SI{1}{\kohm}$  then:
    \[C_2 = \frac{0.15*0.001}{1000} = \SI{15}{\nano\farad}\]
\end{enumerate}
