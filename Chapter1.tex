...
And, we have the following approximation from previous discussions of highpass filters (formula 1.28).
\[\frac{V_R}{V_0} \approx \frac{R}{R + \frac{1}{\omega C}}\]
Thus, 
\[V_R = V_0 * \frac{\omega RC}{1+\omega RC}\]
\[\frac{V_R^2}{R} =\frac{V_0^2}{R} * \frac{(\omega RC)^2}{(1 + \omega RC)^2}=\frac{V_0^2 * \omega^2 RC^2}{(1+\omega RC)^2}\]
